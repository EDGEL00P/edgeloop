...
export const gameFutures: GameFuture[] = [
  {
    id: 'g1',
    homeTeam: teams[0],
    awayTeam: teams[3],
...
export const sgmLegs: SGMLeg[] = [
  { id: 'l1', description: 'KC -3.5', odds: -110, correlation: 0, correlationNote: 'Base outcome', risk: 'medium' },
  { id: 'l2', description: 'Mahomes Over 285.5 Pass Yds', odds: -110, correlation: 0.65, correlationNote: 'High correlation with KC win', risk: 'low' },
  { id: 'l3', description: 'Kelce Over 72.5 Rec Yds', odds: -115, correlation: 0.72, correlationNote: 'Mahomes targets Kelce heavily when ahead', risk: 'low' },
  { id: 'l4', description: 'Kelce Anytime TD', odds: +110, correlation: 0.58, correlationNote: 'Red zone target leader', risk: 'medium' },
  { id: 'l5', description: 'Over 52.5 Total', odds: -110, correlation: 0.45, correlationNote: 'Both offenses elite', risk: 'medium' },
  { id: 'l6', description: 'Allen Over 42.5 Rush Yds', odds: -105, correlation: -0.35, correlationNote: 'Negative correlation - BUF rushing when behind', risk: 'high' },
];
...
export const mockDataImports: DataImport[] = [
  { filename: 'player_stats_2024.csv', rows: 1842, columns: ['player_id', 'name', 'team', 'position', 'yards', 'tds', 'epa'], lastUpdated: '2 hours ago', status: 'loaded' },
  { filename: 'game_outcomes.json', rows: 272, columns: ['game_id', 'home_team', 'away_team', 'score', 'spread_result'], lastUpdated: '1 hour ago', status: 'loaded' },
  { filename: 'injury_report.csv', rows: 156, columns: ['player_id', 'status', 'injury_type', 'estimated_return'], lastUpdated: '30 mins ago', status: 'loaded' },
];
