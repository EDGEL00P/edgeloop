...
description: Detects and fixes GitHub Actions workflows that incorrectly use the Vercel CLI when the repo relies on the Vercel GitHub Integratio
---
...
1. Remove all Vercel CLI install and execution steps from workflows
2. Keep CI steps only:
   - install dependencies
   - lint
   - typecheck
   - tests
   - optional build verification
3. Ensure no workflow references missing Vercel secrets
4. Optionally add a short README note clarifying:
