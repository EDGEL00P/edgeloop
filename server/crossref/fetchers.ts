...
export async function fetchESPNScoreboard(season: number, week: number): Promise<any> {
...
export async function fetchBDLGames(season: number, week: number): Promise<any> {
