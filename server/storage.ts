...
export class DatabaseStorage implements IStorage {
  async getUser(id: string): Promise<User | undefined> {
    try {
      ...
      logger.error({ type: "storage_error", operation: "getUser", id, error: error instanceof Error ? error.message : String(error) });
      throw error;
    }
  }
  ...
  async getUserByEmail(email: string): Promise<User | undefined> {
    try {
      ...
      logger.error({ type: "storage_error", operation: "getUserByEmail", email, error: error instanceof Error ? error.message : String(error) });
      throw error;
    }
  }
  ...
  async createUser(insertUser: UpsertUser): Promise<User> {
    try {
      ...
      logger.error({ type: "storage_error", operation: "createUser", email: insertUser.email, error: error instanceof Error ? error.message : String(error) });
      throw error;
    }
  }
