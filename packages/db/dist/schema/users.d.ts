export declare const userTier: readonly ["free", "pro", "enterprise"];
export type UserTier = (typeof userTier)[number];
export declare const userRole: readonly ["user", "analyst", "admin"];
...
export declare const accounts: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        type: import("drizzle-orm/pg-core").PgColumn<{
            ...
            dataType: "string";
            columnType: "PgVarchar";
            data: import("@auth/core/adapters").AdapterAccountType;
            driverParam: string;
            notNull: true;
            hasDefault: false;
            isPrimaryKey: false;
            ...
            length: 255;
            $type: import("@auth/core/adapters").AdapterAccountType;
        }>;
