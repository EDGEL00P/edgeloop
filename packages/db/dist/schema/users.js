...
export const userTier = ['free', 'pro', 'enterprise'];
export const userRole = ['user', 'analyst', 'admin'];
export const users = pgTable('users', {
    ...
    role: varchar('role', { length: 20 }).notNull().default('user').$type(),
    tier: varchar('tier', { length: 20 }).notNull().default('free').$type(),
