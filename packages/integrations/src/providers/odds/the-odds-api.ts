...
export class TheOddsApiProvider implements OddsProvider {
  ...
  async fetchOdds(sport: string): Promise<OddsData[]> {
  ...
  async fetchGames(sport: string): Promise<GameData[]> {
    const sportKey = sport === 'nfl' ? 'americanfootball_nfl' : sport
  ...
  private extractOdds(gameId: string, bookmaker: z.infer<typeof bookmakerSchema>): OddsData | null {
